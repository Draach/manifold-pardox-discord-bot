...
WORKDIR /source/ManifoldParadoxBot
...
COPY --from=build /app .
COPY manifold-paradox-discord-bot-firebase-adminsdk-ifcqg-513e86b9b2.json /app

ENV GOOGLE_APPLICATION_CREDENTIALS=manifold-paradox-discord-bot-firebase-adminsdk-ifcqg-513e86b9b2.json
...
ENTRYPOINT ["dotnet", "ManifoldParadoxBot.dll"]
